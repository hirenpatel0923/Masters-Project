...
class DataLoader:
    ...
    def _get_AU_OCC_dataframe(self, AU_OCC_path, AU_OCC_filename, base_path, subject, task):
        ...
        csv_df['0'] = csv_df['0'].apply(lambda x: os.path.join(base_path, (x + IMAGE_TYPE)))
    ...
    def load_data(self, Subjects, Tasks):
        ...
        # return df['subject'].values, df['task'].values, df['0'].values, AU_OCC_df.values, AU_INT_df.values
